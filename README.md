...
* 📖 **Богатый выбор слов:** Встроенный словарь на более чем 34 тысячи русских существительных.
...
Этот проект распространяется под лицензией **GNU GPL v3.0**. Полный текст лицензии см. в файле [LICENSE](LICENSE).
